...
function compressImage(base64Image) {
    return new Promise((resolve, reject) => {
        ...
        img.onload = function() {
            ...
            const compressedImage = canvas.toDataURL('image/jpeg', 0.7); // Adjust the quality value (0.0 - 1.0) as needed
...
window.onload = function() {
    ...
    img1.src = 'https://www.ffmcontest.com/images/different-Image-collection1/Original_1.PNG';
    img2.src = 'https://www.ffmcontest.com/images/different-Image-collection1/Duplicate_2.PNG';
...
function saveData() {
    ...
    fetch('https://www.ffmcontest.com:3000/saveData', {
    // fetch('http://13.251.66.119:3000/saveData', {
        method: 'POST',
        headers: {
...
if (gameEnded) {
    ...
    img.setAttribute("src", "https://www.ffmcontest.com/assests/confetti-one.png"); // Replace with your image source
    ...
    title.innerText = "Thank you for Participating!"; // Set the title text
    ...
    quote.innerText = " "; // Set the quote text
